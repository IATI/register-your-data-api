...
def get_discoverable_reporting_orgs(
...
) -> PaginatedResultsPage[DiscoverableReportingOrgMetadata]:
    ...
    discoverable_orgs = [
        get_discoverable_reporting_org_meta_from_suitecrm_response(org["attributes"])
        for org in suitecrm_reporting_orgs["data"]
    ]
